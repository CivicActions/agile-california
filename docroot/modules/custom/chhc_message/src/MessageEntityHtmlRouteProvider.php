...
class MessageEntityHtmlRouteProvider extends AdminHtmlRouteProvider {
  ...
  protected function getAddFormRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('add-form')) {
      ...
      $route
        ->setDefaults([
          '_controller' => 'Drupal\chhc_message\Controller\MessageEntityAddController::addForm',
          '_title_callback' => 'Drupal\chhc_message\Controller\MessageEntityAddController::getAddFormTitle',
        ])
